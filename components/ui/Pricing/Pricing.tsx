  ...
  return (
    <section className="bg-black">
      ...
      <div className={`${showRedirecting ? 'hidden' : ''} max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8`}>
        ...
        مرشد هو أول منصة رقمية في تونس للاستشارة القانونية السريعة على شكل
        سؤال وجواب. يتيح لكم طرح أسئلتكم القانونية والحصول على إجابات دقيقة
        من موسوعتنا في وقت وجيز، سواء كنتم أفرادًا أو محامين أو شركات.
          </p>
